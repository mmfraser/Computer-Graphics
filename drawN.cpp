////////////////////////////////////////////////////////////////
//
//	drawN.cpp - code for Letter N model
// 
...
void drawN (int origin)
{
	...
	glTranslatef(0.1,0.3,0.f) ;	/*glRotatef(,,,) ;*/		glScalef(1.f,0.75,1.f) ;	draw3Dcurve(0.05,0.075,0.125,0.f,180.f,5.f) ;

	//Restaure Matrix to function call, and save) ;	
	glPopMatrix() ;			glPushMatrix() ;

	//Tranformations for the first cube
	glTranslatef(0.2,0.15,0.f) ;	/*glRotatef(,,,) ;*/		glScalef(1.f,6.f,1.f) ;		cube() ;
